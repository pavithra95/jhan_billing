                    ...
                    <div class="row">
                       ...
                       <div class="col-md-4">
                        ...
                        <div class="form-group @if($errors->has('invoice_no')) text-danger @endif">
                            ...
                            <input type="text" name="invoice_no" class="form-control" id="invoice_no" required="required" value="{{generateSalesInvoiceNo()}}" disabled="">
                ...
                <div class=row>
                    <div class="col-md-4">
                        ...
                        <div class="form-group @if($errors->has('due_date')) text-danger @endif">
                            ...
                            <input type="text" name="due_date" class="form-control date-picker" id="" value="{{date('Y-m-d')}}" >
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="form-group @if($errors->has('due_date')) text-danger @endif">
                            ...
                            <input type="text" name="reference_no" class="form-control "  value="" >
                            @if($errors->has('due_date'))
                            <div class="error text-danger">{{ $errors->first('due_date') }}</div>
                            @endif
