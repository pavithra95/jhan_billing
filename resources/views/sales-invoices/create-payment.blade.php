        ...
        <div class="card">
            <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group" >
                               ...
                               <select name="customer_id" id="input" class="form-control select2" required="">
                                <option value=""></option>
               ...
               <div id="payment">
                ...
                <form action="/new-sales-payment" method="POST" role="form" class="col-md-12 " autocomplete="off">
                    {{ csrf_field() }}
                    ...
                    <div class="row">
                        ...
                        <div> <br/>
                         ...
                         <a class="btn btn-primary btn-sm" href='/new-sales-payment'>Change Customer </a>
                     ...
                     <div class="row">
                         ...
                         {{-- <input type="hidden" name="payment" v-model="full_amount" class="form-control" value=""  style="width: 198px" required="required">
                                --}}
                              ...
                              <tbody>
                                ...
                                <input type="hidden" name="invoices[]" :value="item.id">
                                  ...
                                  <td>
                                    ...
                                    <input type="text" v-model="item.amount" disabled="">
                                     <input type="hidden" name="paid_amount[]" v-model="item.amount" >
                                    </div>
                                    <div v-else>
                                     <input type="number" name="paid_amount[]" v-model="item.amount" :max="item.balance_amount" :min="0"required="" style="width: 150px">
                                     </div> 
                                  </td>
               ...
               <button disabled="" type="submit" class="btn btn-primary btn-sm">Save</button>
                ...
                <template v-else>
                   ...
                   <div class="row">
                       ...
                       <h3>No Pending Invoices for Customer</h3>
