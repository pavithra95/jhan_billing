...
<div class="row" id="invoice-app">
    ...
    <div class="col-md-12">
        ...
        <h4 class="m-0 text-dark col-md-6 float-left">{{$title}}</h4>
         ...
         <a class="btn btn-primary float-right margin-right btn-sm" href='/purchase-invoices'>Back </a>
 ...
 -->
         @if ($sales->paid_amount != $sales->total_amount)
              ...
              <a class="btn btn-success float-right margin-right btn-sm" href="/create-payment-from-purchase-invoice/{{ $sales->id }}"> Record Payment </a>
