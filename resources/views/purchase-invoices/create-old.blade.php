            ...
            <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group @if($errors->has('customer_id')) text-danger @endif">
                                ...
                                <!--<select v-model="selectedCustomer" name="vendor_id" id="inputCustomer_id" class="form-control" required="required" @input="refreshCustomer">-->
                       ...
                       <div class="col-md-4">
                        ...
                        <div class="form-group @if($errors->has('invoice_no')) text-danger @endif">
                            ...
                            <input type="text" name="invoice_no" class="form-control" id="invoice_no" required="required" value="{{generatePurchaseInvoiceNo()}}" disabled="">
                ...
                <div class=row>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="form-group @if($errors->has('due_date')) text-danger @endif">
                            <label for="">Purchase Invoice No</label>
                            <input type="text" name="reference_no" class="form-control "  value="" required="" >
                            @if($errors->has('due_date'))
                            <div class="error text-danger">{{ $errors->first('due_date') }}</div>
                            @endif
    ...
    var app = new Vue({
      ...
      data: {
        ...
        @foreach ($items as $invoice_item)
        {
             ...
             @php
        $price = $invoice_item->purchase_price;
        $now = \Carbon\Carbon::now();
        if (
             $invoice_item->enable_discount =="on" &&
            $invoice_item->discount_from <= $now &&
            $invoice_item->discount_to >= $now
        ) {
            $price = $invoice_item->discount_price;
        }
    @endphp
            id: "{{$invoice_item->id}}",
...
setItem: function (index, item_new) {
    ...
    // console.log("ppp"+item_new.purchase_price);
    console.log(select_item.tax_items);
    this.invoice_items[index].price = select_item.price;
    this.setRecalculatedamount(index);
...
setOutItem: function (index, item_new) {
    ...
    console.log(select_item.tax_items);
    this.invoice_items[index].price = parseFloat(select_item.price);
    this.setRecalculatedamount(index);
    this.invoice_items[index].group_type_name = {
        id: select_item.pricep_id,
        g_name: select_item.pricep,
