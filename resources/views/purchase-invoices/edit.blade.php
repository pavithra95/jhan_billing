                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group @if($errors->has('customer_id')) text-danger @endif">
                                ...
                                <!--</select>-->
                                 <v-select  :options="customers" label="name" v-model="selectedCustomer" @input="refreshCustomer">
                ...
                <div class=row>
                    <div class="col-md-4">
                        ...
                        <div class="form-group @if($errors->has('due_date')) text-danger @endif">
                            <label for=""> Purchase Invoice Due Date</label>
...
<div class="col-md-6 offset-md-5">
 ...
 <a class="btn btn-danger btn-sm" href='/purchase-invoices'>Cancel </a>
