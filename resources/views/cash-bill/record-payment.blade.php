...
<br>
                ...
                <form action="/create-payment-from-cash/{{ $sales->id }}" method="POST" role="form" class="col-md-12 " autocomplete="off">
                    {{ csrf_field() }}
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group" >
                                ...
                                <input type="hidden" name="customer_id" value="{{$sales->customer_name}}">
                                <div>
               ...
               <a class="btn btn-danger btn-sm" href='/cash-bills/{{$sales->id}}'>Cancel </a>
