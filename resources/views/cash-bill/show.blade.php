...
<div class="row" id="invoice-app">
    ...
    <div class="col-md-12">
        ...
        <h4 class="m-0 text-dark col-md-6 float-left">{{$title}}</h4>
         ...
         <a class="btn btn-primary float-right margin-right btn-sm" href='/cash-bills'>Back </a>
 ...
 -->
         @if ($sales->paid_amount != $sales->total_amount)
              ...
              <a class="btn btn-success float-right margin-right btn-sm" href="/create-payment-from-cash/{{ $sales->id }}"> Record Payment </a>
...
<br>
                ...
                <form action="/{{$url}}/{{ $sales->id }}" method="POST" role="form" class="col-md-12 " autocomplete="off">
                    {{ csrf_field() }}
                    {{ method_field('PUT') }}
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group @if($errors->has('customer_id')) text-danger @endif">
                               ...
                               <span class="hidden-xs">{{ $sales->customer_name }}</span>
                    ...
                    <div class="col-md-4">
                            <div class="form-group @if($errors->has('customer_id')) text-danger @endif">
                                ...
                                <div>
                               <span class="hidden-xs">{{ $sales->customer_phone }}</span>
                                </div>
                       ...
                       <div class="col-md-4">
                            <div class="form-group @if($errors->has('customer_id')) text-danger @endif">
                                ...
                                <div>
                               <span class="hidden-xs">{{ $sales->customer_address }}</span>
                ...
                <div class="col-md-4">
                        ...
                        <div class="form-group @if($errors->has('invoice_date')) text-danger @endif">
                            ...
                            <div>
                           <span class="hidden-xs">{{ $sales->State->name}}</span>
                       </div>
                ...
                <div class=row>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="col-md-4">
                           ...
                           <span class="hidden-xs">{{ $sales->invoice_note}}</span>
                       </div>
                        </div>
                    </div>
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                ...
                <br>
                 <a href="/cash-bills/print/{{$sales->id}}" class="btn btn-outline-primary btn-icon-text float-right ml-2" target="_blank"> <i class="btn-icon-prepend" href="" data-feather="printer">Print</i></a>
