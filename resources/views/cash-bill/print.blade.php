					...
					<table class="table table-bordered">
						<tr>
							<td colspan="2">
								<div class="col-xs-6 company_details">
									...
									<p style="font-size: 16px;"><strong>GSTIN :</strong> 33IESPS8823D1ZX</p>
									<p style="font-size: 16px;"><strong>Address  &nbsp;:</strong> SF.NO : 343/D,Green view Telecom Colony, <p style="font-size: 16px;">Opp to Visakhapatnam Steels, Peelamedu,</p>
									<p style="font-size: 16px;">Coimbatore, Tamil Nadu 641041. </p>       
									<p style="font-size: 16px;"><strong>Mobile   &nbsp;&nbsp;&nbsp;&nbsp;:</strong> +91 9943202090, 9787372757 </p>
									<p style="font-size: 16px;"><strong>Email Id&nbsp;&nbsp;&nbsp;:</strong> srdistributors@gmail.com </p>
									
								</div>
								<div class="col-xs-4" style="width: 48.333333%;padding-left: 130px;">
						...
						<tr>
							<td colspan="2">
								...
								<div class="text-gray-light" style="font-size:16px"><b>BILLED TO:</b></div>
									<h5 class="to"><strong>{{$sales->customer_name}}</strong></h5>
									<div class="address">{{$sales->customer_address}}</div>
									
									<div class="address">{{$sales->customer_phone}}</div>
									<!--  -->
								</div>
								<div class="col-xs-5" style="vertical-align:middle;text-align:right;margin-top: -10px;">
								<div class="text-gray-light"><b></b></div><br>
								<h3 class="title text-center" style="letter-spacing: 6px;font-size: xx-large;font-weight: 600;">CASH BILL</h3><br>
						...
						<thead>
							...
							<tr>
								...
								<div class="col-xs-6">
									...
									<!--<p style="vertical-align:middle;text-align:left;">GRAND TOTAL : {{ number_format($sales->total_amount,2) }}</p>-->
									<div class="clearfix"></div>
									<div class="height20"></div>
									<div class="height10"></div>
								</th>
							...
							<tr>
								...
								<!--<th style="vertical-align:middle;text-align:left;width:50%;">
									...
									<h6></h6>
									<p style="font-size:14px;font-weight:450">1. Goods once sold cannot be taken back.</p>
									<div class="height08"></div>
									<p style="font-size:14px;font-weight:450">2. Interest @24% p.a will be charged if the payment is not made within the stipulated time.</p>
									<div class="height08"></div>
									<p style="font-size:14px;font-weight:450">3. Subject to 'Coimbatore' Jurisdiction.</p>
									<div class="clearfix"></div>
									<div class="height20"></div>
									<div class="height10"></div>
								</th>
								<th style="vertical-align:middle;text-align:left;width:50%;">
									...
									<p style="font-size:14px;font-weight:450">Bank Name : SOUTH INDIAN BANK</p>
									<div class="height07"></div>
									<p style="font-size:14px;font-weight:450">Account Number : 11235689741055</p>
									<div class="height07"></div>
									<p style="font-size:14px;font-weight:450">IFSC Code : AMB258963</p>
									<div class="clearfix"></div>
									<div class="height30"></div>
									<div class="height10"></div>
								</th>-->
