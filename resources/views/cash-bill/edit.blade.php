                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group @if($errors->has('customer_id')) text-danger @endif">
                               ...
                               <input type="text" name="customer_name" class="form-control" required="" value="{{$sales->customer_name}}">
                       ...
                       <div class="col-md-4">
                            <div class="form-group @if($errors->has('customer_id')) text-danger @endif">
                               ...
                               <input type="text" name="customer_phone" class="form-control" value="{{$sales->customer_phone}}">
                       ...
                       <div class="col-md-4">
                            <div class="form-group @if($errors->has('customer_id')) text-danger @endif">
                              ...
                              <textarea name="customer_address" id="" class="form-control">{{$sales->customer_address}}</textarea>
                        ...
                        <div class="form-group @if($errors->has('invoice_date')) text-danger @endif">
                            ...
                            <select name="state_id" id="inputState" class="form-control" required="required" disabled="">
                                @foreach ($states as $state)
                                    {{-- expr --}}
                                <option @if ($state->id == $sales->state_id) selected=""
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="form-group @if($errors->has('due_date')) text-danger @endif">
                            ...
                            <select name="payment_method_id" id="inputPayment_method_id" class="form-control" required="required">
                                ...
                                {{-- expr --}}
                                <option @if ($item->id == $sales->payment_method_id) selected="" 
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="form-group @if($errors->has('due_date')) text-danger @endif">
                                ...
                                <textarea name="notes" id="" class="form-control">{{$sales->invoice_note}}</textarea>
                            ...
                            <tbody>
                                ...
                                <template v-for="item in taxes">
                                    ...
                                    <template v-for="tax in item.items">
                                        <tr v-if="getGstamountInclusive(item.id, tax.id, item.items.length) > 0">
                                            <td></td>
                                            <td></td>
                                            <td></td>
                                            <td class="amount">@{{tax.name}}
                                             ...
                                             <input type="hidden" name="gst_amount[]" :value="getGstamountInclusive(item.id, tax.id, item.items.length)">
                                         </td>
                                         <td class="amount">@{{getGstamountInclusive(item.id, tax.id, item.items.length)}}</td>
...
mounted() {
    ...
    this.setRecalculatedamount(i, true);
    }
    },
...
getCessAmountInclusive: function (id, length) {
    ...
    getGstamountInclusive: function (group_id, id, length) {
        var self = this;
        var amount = 0;
        this.invoice_items.forEach(function(entry) {

            if(entry.group_type_name != null) {
            if(entry.group_type_name.id == group_id) {
 ...
 this.invoice_items[index].cess_amount = this.invoice_items[index].cess_amount * this.invoice_items[index].quantity;
    ...
    setRecalculatedamount: function (index, isFirst = false) {
        // if(!isFirst) {
