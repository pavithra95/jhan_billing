...
<div class="row">
    ...
    <div class="col-md-12">
        ...
        <h4 class="m-0 text-dark col-md-6 float-left">Create Product Category</h4>
...
<br>
                ...
                <form action="/product-categories" method="POST" role="form" class="col-md-12" autocomplete="off">
                    {{ csrf_field() }}
