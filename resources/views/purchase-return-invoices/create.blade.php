                    ...
                    <div class="row">
                       ...
                       <div class="col-md-4">
                        ...
                        <div class="form-group @if($errors->has('invoice_no')) text-danger @endif">
                            ...
                            <input type="text" name="invoice_no" class="form-control" id="invoice_no" required="required" value="{{generatePurchaseReturnInvoiceNo()}}" disabled="">
                ...
                <div class=row>
                    <div class="col-md-4">
                        ...
                        <div class="form-group @if($errors->has('due_date')) text-danger @endif">
                            ...
                            <input type="text" name="due_date" class="form-control date-picker " required="" value="{{date('Y-m-d')}}" >
...
<div class="col-md-6 offset-md-5">
 ...
 <a class="btn btn-danger btn-sm" href='/purchase-return-invoices'>Cancel </a>
