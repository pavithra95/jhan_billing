...
@section('content')
<div class="container">
    <h2>Create Purchase Return Invoice</h2>

    <!-- Customer Info -->
    <form action="/purchase-return-invoices" method="POST" role="form" class="col-md-12" autocomplete="off">
        {{ csrf_field() }}
        <div class="row">
            <div class="mb-3 col-md-4">
                <label>Supplier Phone</label>
                <input type="text" id="supplierPhone" class="form-control" name="supplier_phone">
            </div>

            <div class="mb-3 col-md-4">
                <label>Supplier Name</label>
                <input type="text" id="supplierName" class="form-control" name="supplier_name">
            </div>
            <div class="mb-3 col-md-4">
             <div class="form-group @if($errors->has('invoice_no')) text-danger @endif">
                            <label for="">Invoice Number</label>
                            <input type="text" name="invoice_no" class="form-control" id="invoice_no" required="required" value="{{generatePurchaseReturnInvoiceNo()}}">
        ...
        fetch(`/get-vendor-by-phone-return?phone=${encodeURIComponent(phone)}`)
            ...
            .then(data => {
                if (data) {
                    ...
                    salesInvoiceInput.value = data?.purchase_invoice_no || ''; // Optional input field
                } else {
                    nameInput.value = '';
