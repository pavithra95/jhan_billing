						...
						<tr>
							<td colspan="2">
								...
								<div class="col-xs-2" style="width: 48.333333%;padding-left: 130px;">
									...
									<h3 class="title text-center" style="letter-spacing: 5px;font-size: 32px;font-weight: 600;">DEBIT NOTE</h3>
						...
						<tr>
							<td colspan="2">
								...
								<div class="text-gray-light" style="line-height: 1.8;"><b>BILLED TO:</b></div>
									<h5 class="to"><strong>{{$sales->vendor->name}}</strong></h5>
									<div class="address"><b>GSTIN :</b> {{$sales->vendor->gst_no}}</div>
									<div class="address"><b>Address : </b> {{$sales->vendor->address}}</div>
									<!--<div class="address"><b>City: </b>{{$sales->vendor->city}}</div>-->
									<div class="address"><b>Mobile : </b> {{$sales->vendor->phone}}</div>
									<!--<div class="address"><b>GSTIN :</b>{{$sales->vendor->gst_no}}</div>-->
								</div>
					...
					<table class="table table-bordered" style="margin-bottom: 0px;" height="auto">
						...
						<tbody>
							...
							<tr>
								...
								<td style="vertical-align:middle;width:150px;text-align:center;text-transform:uppercase;">{{$item->product->hsn_code}}</td>
