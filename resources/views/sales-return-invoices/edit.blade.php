                           ...
                           <div class="row">
                              <div class="col-md-4">
                                 <div class="form-group @if($errors->has('customer_id')) text-danger @endif">
                                    ...
                                    <!--<select v-model="selectedCustomer" name="customer_id" id="inputCustomer_id" class="form-control" @input="refreshCustomer" required="required">-->
                           ...
                           <div class=row>
                              ...
                              <div class="col-md-4">
                                 <div class="form-group @if($errors->has('due_date')) text-danger @endif">
                                    ...
                                    <input type="text" name="reference_no" class="form-control "  required="" value="{{$sales->reference_no}}" >
                                    @if($errors->has('due_date'))
                                    <div class="error text-danger">{{ $errors->first('due_date') }}</div>
                                    @endif
                                 </div>
                              ...
                              <div class="col-md-4">
                                 <div class="form-group @if($errors->has('due_date')) text-danger @endif">
                                     ...
                                     <select name="payment_method_id" id="inputPayment_method_id" class="form-control" required="required">
                                         ...
                                         {{-- expr --}}
                                         <option @if ($sales->payment_method_id == $item->id ) selected="" 
   ...
   var app = new Vue({
     ...
     data: {
       ...
       selectedCustomer: {
           ...
           state_id: "{{$sales->customer->state_id}}",
       },
       gsts: [],
