...
<div class="row" id="invoice-app">
    ...
    <div class="col-md-12">
        ...
        <h4 class="m-0 text-dark col-md-6 float-left">{{$title}}</h4>
         ...
         <a class="btn btn-primary float-right margin-right btn-sm" href='/sales-return-invoices'>Back </a>
...
<br>
    ...
    <a href="/sales-return-invoice/print/{{$sales->id}}" class="btn btn-outline-primary btn-icon-text float-right ml-2" target="_blank"> <i class="btn-icon-prepend" href="" data-feather="printer"></i>PRINT</a>
