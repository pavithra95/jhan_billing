...
<div class="row" id="test">
    ...
    <div class="col-md-12">
        ...
        <h4 class="m-0 text-dark col-md-6 float-left">Update Unit</h4>
...
<br>
                ...
                <form action="/units/{{$unit->id}}" method="POST" role="form" class="col-md-12 " autocomplete="off">
                    {{ csrf_field() }}
                    {{method_field('PUT')}}
                  ...
                  <button type="submit" class="btn btn-primary col-md-2 offset-md-3 btn-sm">Update</button>
                   <a class="btn btn-danger col-md-2 btn-sm" href='/units/{{$unit->id}}'>Cancel </a>
                </form>
