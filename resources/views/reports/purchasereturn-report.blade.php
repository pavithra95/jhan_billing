...
<div class="row">
    ...
    <div class="col-md-12">
        ...
        <h4 class="m-0 text-dark col-md-6 float-left">Purchase Return Report</h4>
                 ...
                 <table id="example" class="display nowrap" style="width:100%">
                    <thead>
                        <tr>
                            ...
                            <!--<th>Serial No</th>--><th>Debit Note No</th>
                            <!--<th>Pur.Invoice No</th>--><!--<th>Aganist Invoice No</th>--><th>Debit Note Date</th>
                            <!--<th>Debit Note Date</th>--><th>Aganist Invoice No</th>
                            <th>Aganist Invoice Date</th>
                    ...
                    <tbody>
                      @foreach ($original as $key => $o)
                        @foreach ($o as $key => $t)
                          ...
                          <td>{{$t['gst_no']}}</td>
                          <td>{{$t['invoice_no']}}</td>
                          <!--<td>{{$t['reference_no']}}</td>--><td>{{$t['invoice_date']}}</td>
                          <!--<td>{{$t['invoice_date']}}</td>--> <td>{{$t['reference_no']}}</td>
                          <td>{{$t['due_date']}}</td> 
                          <td>{{$t['bill_amount']}}</td>
                          @if ($t['gst_rate'] > 0 )
