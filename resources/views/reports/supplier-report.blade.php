...
<div class="row">
    ...
    <div class="col-md-12">
        ...
        <h4 class="m-0 text-dark col-md-6 float-left">Supplier Report</h4>
             ...
             <div class="col-md-3">
              <div class="form-group">
                <label class="" for="">Supplier Name</label>
                     ...
                     <input type="text" name="vendor_id" class=" form-control"  value="{{ $vendor_id }}" autocomplete="off" placeholder="Supplier Name">
            </div>
...
<br>
               ...
               <table id="example" class="display nowrap" style="width:100%">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>{{ $key + 1 }}</td>
                            <td><a href="/reports-supplier-invoice/{{ $item->id }}">{{ $item->name }}</a></td>
                            <td>{{ $item->phone }}</td>
                            <td>{{ $item->gst_no }}</td>
