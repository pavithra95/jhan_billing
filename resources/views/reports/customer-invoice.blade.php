...
<div class="row">
    ...
    <div class="col-md-12">
        ...
        <h4 class="m-0 text-dark col-md-6 float-left">{{ucwords($customer->name)}}'s Invoice Details</h4>

         <a class="btn btn-primary float-right btn-sm" href="/customer-report"> Back </a>
