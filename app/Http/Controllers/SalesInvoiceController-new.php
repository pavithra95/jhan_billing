...
class SalesInvoiceController extends Controller
{
    ...
    public function index()
    {
        ...
        $customers = Customer::all();
         ...
         $total_paid_amount = SalesInvoice::whereBetween('invoice_date',[$from,$to])->sum('paid_amount');
    ...
    public function create()
    {
        ...
        return view('sales-invoices.create')->with(compact(['url','title','customers','items','items_out','payment','taxes','taxes_out','cess_taxes','cess_taxes_out']));
    }
    ...
    public function store(Request $request)
    {
        ...
        $invoice->invoice_no = generateSalesInvoiceNo();
