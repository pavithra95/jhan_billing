...
class PurchaseInvoiceController extends Controller
{
    ...
    public function index()
    {
        ...
        $suppliers = Vendors::all();
         ...
         $total_paid_amount = PurchaseInvoice::whereBetween('invoice_date',[$from,$to])->sum('paid_amount');
        ...
        return view('purchase-invoices.index')->with(compact([ 'url','title','add_text','purchase','supplier','from','to','suppliers','total_paid_amount','total_due_amount','total_bill_amount','pay_status']));
    }
    ...
    public function create()
    {
        ...
        return view('purchase-invoices.create')->with(compact(['url','title','customers','items','items_out','payment','taxes','taxes_out','cess_taxes','cess_taxes_out']));
    }
    ...
    {
        $old_items = PurchaseInvoiceItem::where('invoice_id', $id)->get(['item_id']);
        PurchaseInvoiceItem::where('invoice_id', $id)->delete();
        PurchaseInvoice::find($id)->delete();
         $transaction = Transaction::where('row_id', $id)->where('table_name','purchase_invoices')->first();
